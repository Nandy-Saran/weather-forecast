...
def home1(request):
    ...
    for i in WeathObj:
        ...
        if instanc.crop1.MintempC and instanc.crop1.MintempC < i.mintempC:
            message += 'Your Crop ' + i.name + ' may get affected due to cold temperature(' + i.mintempC + ' deg C) in' + i.datenum + 'day(s)\n'
        if instanc.crop1.MaxtempC and instanc.crop1.MaxtempC > i.maxtempC:
            message += 'Your Crop ' + i.name + ' may get affected due to high temperature( ' + i.maxtempC + ' deg C) in' + i.datenum + 'day(s)\n'
